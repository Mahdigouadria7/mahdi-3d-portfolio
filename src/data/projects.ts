...
export const projects: Project[] = [
    ...
    },
    {
        ...
        accent: "emerald",
        title: "DANAO 3D CGI — JUICE & MILK",
        category: "Commercial Packaging & 3D CGI",
        description: "Full 3D commercial campaign for Danao Juice & Milk featuring photorealistic PBR liquid shaders, island environment animations, and interactive 3D bottle viewer.",
        client: "Danao (Danone Group)",
        role: "3D Artist: Mahdi Gouadria",
        timeline: "2025",
