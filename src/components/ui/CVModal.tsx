...
function DateBadge({ children }: { children: React.ReactNode }) {
    return (
        <span className="font-sans text-xs md:text-sm font-bold text-emerald-700 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200 inline-block whitespace-nowrap shadow-2xs">
            {children}
        </span>
    );
}
                ...
                {currentViewMode === "dial" ? (
                        ...
                        <div className="flex-1 overflow-y-auto p-6 md:p-10 space-y-6 max-h-[78vh] touch-pan-y overscroll-contain">
                            ...
                            {activeIndex === 0 && (
                                <div className="space-y-6 animate-fadeIn">
                                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-5">
                                        <div className="flex items-center gap-2">
                                            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
                                            <span className="font-sans text-xs md:text-sm font-bold tracking-[0.2em] uppercase text-emerald-700">
                                                Profil — Executive Summary
                                            </span>
                                        </div>
                                        <h3 className="font-playfair text-2xl md:text-3xl lg:text-4xl text-[#191919] font-extrabold leading-tight">
                                            3D Generalist &amp; Software Engineer
                                        </h3>
                            ...
                            {activeIndex === 1 && (
                                <div className="space-y-6 animate-fadeIn">
                                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-8">
                                        <div className="flex justify-between items-center border-b border-[#191919]/10 pb-4">
                                        ...
                                        {/* Innov8 Agency */}
                                        <div className="border-l-2 border-[#191919] pl-4 space-y-3">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                                <h4 className="font-sans text-lg md:text-xl font-extrabold text-[#191919]">3D ARTIST – INNOV8 CREATIVE AGENCY</h4>
                                                <DateBadge>May 2024 — Present</DateBadge>
                                            </div>
                                            <ul className="list-disc list-inside font-sans text-sm md:text-lg text-[#191919]/90 space-y-2 leading-relaxed font-normal">
                                            ...
                                            <div className="pt-3 border-t border-[#191919]/10">
                                                <span className="font-sans text-xs font-bold uppercase tracking-wider text-[#191919]/60 block mb-1.5">Key Clients &amp; Brands:</span>
                                                <p className="font-sans text-sm md:text-base text-[#191919] font-semibold leading-relaxed bg-[#191919]/5 p-3 rounded-xl border border-[#191919]/10">
                                        ...
                                        {/* SheTech Studio */}
                                        <div className="border-l-2 border-[#191919]/30 pl-4 space-y-3 pt-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                                <h4 className="font-sans text-lg md:text-xl font-extrabold text-[#191919]">3D ARTIST – SHETECH STUDIO (VR Game Dev)</h4>
                                                <DateBadge>Oct 2022 — Apr 2024</DateBadge>
                                            </div>
                                            <p className="font-sans text-sm md:text-base text-[#191919]/70 font-semibold">Tunisia</p>
                                            <ul className="list-disc list-inside font-sans text-sm md:text-lg text-[#191919]/90 space-y-2 leading-relaxed font-normal">
                                        ...
                                        <div className="border-l-2 border-[#191919]/30 pl-4 space-y-3 pt-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                                <h4 className="font-sans text-lg md:text-xl font-extrabold text-[#191919]">UX/UI DESIGNER &amp; WEB DEVELOPER – EURO TECH CONSEIL (ETC)</h4>
                                                <DateBadge>Feb 2022 — Nov 2022</DateBadge>
                                            </div>
                                            <p className="font-sans text-sm md:text-base text-[#191919]/70 font-semibold">Kairouan, Tunisia</p>
                                            <ul className="list-disc list-inside font-sans text-sm md:text-lg text-[#191919]/90 space-y-2 leading-relaxed font-normal">
                                        ...
                                        <div className="border-l-2 border-[#191919]/30 pl-4 space-y-3 pt-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                                <h4 className="font-sans text-lg md:text-xl font-extrabold text-[#191919]">WEBGL &amp; INTERACTIVE WEB DEVELOPER – GPRO</h4>
                                                <DateBadge>2021</DateBadge>
                                            </div>
                                            <p className="font-sans text-sm md:text-base text-[#191919]/70 font-semibold">Sousse, Tunisia</p>
                                            <ul className="list-disc list-inside font-sans text-sm md:text-lg text-[#191919]/90 space-y-2 leading-relaxed font-normal">
                                        ...
                                        <div className="border-l-2 border-[#191919]/30 pl-4 space-y-3 pt-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                                <h4 className="font-sans text-lg md:text-xl font-extrabold text-[#191919]">GAME DESIGNER &amp; 3D ASSET SPECIALIST (INTERNSHIP) – IT GATE</h4>
                                        ...
                                        <div className="border-l-2 border-[#191919]/30 pl-4 space-y-3 pt-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                                                <h4 className="font-sans text-lg md:text-xl font-extrabold text-[#191919]">FREELANCE 3D ARTIST &amp; CGI DESIGNER</h4>
                                                <DateBadge>2019 — Present</DateBadge>
                                            </div>
                                            <p className="font-sans text-sm md:text-lg text-[#191919]/90 leading-relaxed font-normal">
                                                Developed high-end CGI commercials, product renders, and 3D motion graphics for international and local clients.
                                            </p>
                                            <div className="pt-2">
                                                <span className="font-sans text-xs font-bold uppercase tracking-wider text-[#191919]/60 block mb-1">Selected Clients:</span>
                                                <span className="font-sans text-sm md:text-base text-[#191919] font-semibold">
                            ...
                            {activeIndex === 2 && (
                                <div className="space-y-6 animate-fadeIn">
                                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-6">
                                        <h3 className="font-playfair text-2xl md:text-3xl text-[#191919] font-bold border-b border-[#191919]/10 pb-3">
                                            Software <em className="font-playfair italic font-normal">&amp; Core Tools</em>
                                        </h3>
                                        
                                        <div className="space-y-5">
                                            <div>
                                                <span className="font-sans text-xs md:text-sm font-bold text-[#191919]/70 uppercase tracking-wider block mb-3">3D Modeling, Texturing &amp; Simulation</span>
                                                <div className="flex flex-wrap gap-2.5">
                                                    {["Blender 3D", "HoudiniFX", "EmberGen", "Substance Painter", "AccuRig", "ZBrush", "VR/AR Pipelines"].map((tool) => (
                                                        <span key={tool} className="px-3.5 py-2 bg-[#191919]/5 border border-[#191919]/10 rounded-full font-sans text-xs md:text-sm font-semibold text-[#191919]">
                                                            {tool}
                                                        </span>
                                                    ))}
                                                </div>
                                            ...
                                            <div>
                                                <span className="font-sans text-xs md:text-sm font-bold text-[#191919]/70 uppercase tracking-wider block mb-3">Motion Graphics &amp; Post-Production</span>
                                                <div className="flex flex-wrap gap-2.5">
                                            ...
                                            <div>
                                                <span className="font-sans text-xs md:text-sm font-bold text-[#191919]/70 uppercase tracking-wider block mb-3">Software Engineering &amp; WebGL</span>
                                                <div className="flex flex-wrap gap-2.5">
                                ...
                                <div className="space-y-6 animate-fadeIn">
                                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-6">
                                        ...
                                        <div className="space-y-6">
                                            <div className="border-l-3 border-[#191919] pl-5 space-y-2">
                                                <div className="flex justify-between items-baseline gap-2">
                                                    <h4 className="font-sans text-base md:text-lg font-bold text-[#191919]">Software Engineering Degree</h4>
                                                    <DateBadge>2019 — 2022</DateBadge>
                                                </div>
                                                <p className="font-sans text-xs md:text-sm text-[#191919]/70 font-semibold">École Polytechnique de Sousse</p>
                                                <p className="font-sans text-sm md:text-base text-[#191919]/90 italic pt-1 leading-relaxed">
                                            ...
                                            <div className="border-l-3 border-[#191919]/30 pl-5 space-y-2">
                                                <div className="flex justify-between items-baseline gap-2">
                                                    <h4 className="font-sans text-base md:text-lg font-bold text-[#191919]">Computer Science Degree</h4>
                                                    <DateBadge>2016 — 2019</DateBadge>
                                                </div>
                                                <p className="font-sans text-xs md:text-sm text-[#191919]/70 font-semibold">ISIG Kairouan</p>
                                                <p className="font-sans text-sm md:text-base text-[#191919]/90 italic pt-1 leading-relaxed">
                                            ...
                                            <div className="border-l-3 border-[#191919]/30 pl-5 space-y-2">
                                                <div className="flex justify-between items-baseline gap-2">
                                                    <h4 className="font-sans text-base md:text-lg font-bold text-[#191919]">Baccalaureate Mathematics</h4>
                                                    <DateBadge>2015 — 2016</DateBadge>
                                                </div>
                                                <p className="font-sans text-xs md:text-sm text-[#191919]/70 font-semibold">Dar Lamen High School, Kairouan</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {activeIndex === 4 && (
                                <div className="space-y-6 animate-fadeIn">
                                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-6">
                                        ...
                                        <ul className="space-y-5 font-sans text-sm md:text-base text-[#191919]">
                                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-[#191919]/10 pb-4">
                                                <span className="font-semibold text-[#191919]/60">Email Address</span>
                                                <a href="mailto:mahdigouadria8@gmail.com" className="font-extrabold hover:underline text-[#191919] mt-1 sm:mt-0 text-base md:text-lg">
                                                    mahdigouadria8@gmail.com
                                                </a>
                                            </li>
                                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-[#191919]/10 pb-4">
                                                <span className="font-semibold text-[#191919]/60">Phone / WhatsApp</span>
                                                <a href="tel:+21621833752" className="font-extrabold hover:underline text-[#191919] mt-1 sm:mt-0 text-base md:text-lg">
                                                    +216 21-833-752
                                                </a>
                                            </li>
                                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-[#191919]/10 pb-4">
                                            ...
                                            <li className="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-1">
                                                ...
                                                <div className="flex gap-4 font-bold mt-1 sm:mt-0">
                            ...
                            {activeIndex === 5 && (
                                <div className="space-y-6 animate-fadeIn">
                                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-6">
                                        ...
                                        <ul className="list-disc list-inside font-sans text-base md:text-lg text-[#191919]/90 space-y-4 leading-relaxed font-normal">
                    ...
                    >
                        ...
                        <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#191919]/15 shadow-sm space-y-4">
                            ...
                            <h3 className="font-playfair text-2xl md:text-3xl font-extrabold text-[#191919]">Gouadria Mahdi — 3D Generalist &amp; Software Engineer</h3>
                            <p className="font-sans text-base md:text-lg text-[#191919] leading-relaxed font-normal">
                                Driven Tunisian 3D Artist with a strong software engineering background, blending technical precision with creative vision to produce high-quality CGI, motion design, and product visualizations. Experienced in working with top brands, optimizing assets for VR/AR, and collaborating with multidisciplinary teams to deliver impactful visual content.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                            ...
                            <div className="md:col-span-5 space-y-6">
                                ...
                                <section className="bg-white rounded-2xl p-6 border border-[#191919]/15 shadow-sm">
                                    <h3 className="font-playfair text-xl md:text-2xl text-[#191919] font-bold mb-4 border-b border-[#191919]/10 pb-2">
                                        Contact <em className="font-playfair italic font-normal">&amp; Info</em>
                                    </h3>
                                    <ul className="space-y-3 font-sans text-sm md:text-base text-[#191919]">
                                ...
                                <section className="bg-white rounded-2xl p-6 border border-[#191919]/15 shadow-sm">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {["Blender 3D", "HoudiniFX", "EmberGen", "Substance Painter", "AccuRig", "ZBrush", "After Effects", "DaVinci Resolve", "Photoshop", "Illustrator", "FL Studio", "Three.js", "WebGL / GLSL", "React / Next.js", "Node.js", "Express.js", "MongoDB", "Angular"].map((tool) => (
                                            <span key={tool} className="px-3 py-1.5 bg-[#191919]/5 border border-[#191919]/10 rounded-full font-sans text-xs md:text-sm font-semibold text-[#191919]">
                                                {tool}
                                            </span>
                                        ))}
                                    </div>
                                ...
                                {/* Achievements */}
                                <section className="bg-white rounded-2xl p-6 border border-[#191919]/15 shadow-sm">
                                    <h3 className="font-playfair text-xl md:text-2xl text-[#191919] font-bold mb-3 border-b border-[#191919]/10 pb-2">
                                        Key <em className="font-playfair italic font-normal">Achievements</em>
                                    </h3>
                                    <ul className="list-disc list-inside font-sans text-sm md:text-base text-[#191919]/80 space-y-2.5 leading-relaxed">
                            ...
                            <div className="md:col-span-7 space-y-6">
                                ...
                                <section className="bg-white rounded-2xl p-6 border border-[#191919]/15 shadow-sm">
                                    <h3 className="font-playfair text-xl md:text-2xl text-[#191919] font-bold mb-6 border-b border-[#191919]/10 pb-2">
                                        Complete Work <em className="font-playfair italic font-normal">Experience</em>
                                    </h3>
                                    <div className="space-y-6">
                                        
                                        {/* Innov8 */}
                                        <div className="border-l-3 border-[#191919] pl-4 space-y-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                                <h4 className="font-sans text-base font-bold text-[#191919]">3D ARTIST – INNOV8 CREATIVE AGENCY</h4>
                                                <DateBadge>May 2024 — Present</DateBadge>
                                            </div>
                                            <ul className="list-disc list-inside font-sans text-sm text-[#191919]/80 space-y-1 leading-relaxed">
                                                <li>Produced 3D motion design and CGI videos for high-profile marketing campaigns.</li>
                                                <li>Designed engaging call-to-actions combining 3D and 2D elements.</li>
                                                <li>Collaborated with graphic designers and production teams.</li>
                                            </ul>
                                            <div className="pt-2 border-t border-[#191919]/5">
                                                <span className="font-sans text-xs font-bold uppercase tracking-wider text-[#191919]/50 block mb-1">Key Clients &amp; Brands:</span>
                                                <p className="font-sans text-xs md:text-sm text-[#191919] font-semibold leading-relaxed bg-[#191919]/5 p-2.5 rounded-lg">
                                                    Samsung, LG Electronics, Délice Danone, Orange, UBCI Bank, Papillon, Kif Biscuit, Mall of Sfax &amp; Sousse, Jouda, Danup, Danao, Eau Délice, Rose Blanche.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        {/* SheTech */}
                                        <div className="border-l-3 border-[#191919]/30 pl-4 space-y-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                                <h4 className="font-sans text-base font-bold text-[#191919]">3D ARTIST – SHETECH STUDIO (VR Game Dev)</h4>
                                                <DateBadge>Oct 2022 — Apr 2024</DateBadge>
                                            </div>
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">Tunisia</p>
                                            <ul className="list-disc list-inside font-sans text-sm text-[#191919]/80 space-y-1 leading-relaxed">
                                        ...
                                        <div className="border-l-3 border-[#191919]/30 pl-4 space-y-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                                <h4 className="font-sans text-base font-bold text-[#191919]">UX/UI DESIGNER &amp; WEB DEVELOPER – EURO TECH CONSEIL (ETC)</h4>
                                                <DateBadge>Feb 2022 — Nov 2022</DateBadge>
                                            </div>
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">Kairouan, Tunisia</p>
                                            <ul className="list-disc list-inside font-sans text-sm text-[#191919]/80 space-y-1 leading-relaxed">
                                        ...
                                        <div className="border-l-3 border-[#191919]/30 pl-4 space-y-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                                <h4 className="font-sans text-base font-bold text-[#191919]">WEBGL &amp; INTERACTIVE WEB DEVELOPER – GPRO</h4>
                                                <DateBadge>2021</DateBadge>
                                            </div>
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">Sousse, Tunisia</p>
                                            <p className="font-sans text-sm text-[#191919]/80 leading-relaxed">Interactive web application integrating real-time 3D models with Three.js &amp; React.js.</p>
                                        </div>

                                        {/* IT Gate */}
                                        <div className="border-l-3 border-[#191919]/30 pl-4 space-y-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                                <h4 className="font-sans text-base font-bold text-[#191919]">GAME DESIGNER &amp; 3D ASSET SPECIALIST – IT GATE</h4>
                                                <DateBadge>2019</DateBadge>
                                            </div>
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">Sousse, Tunisia</p>
                                            <p className="font-sans text-sm text-[#191919]/80 leading-relaxed">3D game environments &amp; Kairouan architectural heritage assets for graduation project (excellent mark).</p>
                                        </div>

                                        {/* Freelance */}
                                        <div className="border-l-3 border-[#191919]/30 pl-4 space-y-2">
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1">
                                                <h4 className="font-sans text-base font-bold text-[#191919]">FREELANCE 3D ARTIST &amp; CGI DESIGNER</h4>
                                                <DateBadge>2019 — Present</DateBadge>
                                            </div>
                                            <p className="font-sans text-sm text-[#191919]/80 leading-relaxed">CGI ads, product renders, and motion graphics for Bioderma Cosmetics, Karina, Yves Rocher, and GPlex Cosmetics.</p>
                                        </div>
                                ...
                                <section className="bg-white rounded-2xl p-6 border border-[#191919]/15 shadow-sm">
                                    ...
                                    <div className="space-y-4">
                                        <div className="border-l-3 border-[#191919] pl-3 space-y-1">
                                            <div className="flex justify-between items-baseline gap-2">
                                                <h4 className="font-sans text-sm font-bold text-[#191919]">Software Engineering Degree</h4>
                                                <DateBadge>2019 — 2022</DateBadge>
                                            </div>
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">École Polytechnique de Sousse</p>
                                            <p className="font-sans text-xs md:text-sm text-[#191919]/90 italic pt-0.5">Final Project: Enterprise HR software for ETC Tunisie combining UX/UI, 3D elements, and engineering.</p>
                                        </div>

                                        <div className="border-l-3 border-[#191919]/20 pl-3 space-y-1">
                                            <div className="flex justify-between items-baseline gap-2">
                                                <h4 className="font-sans text-sm font-bold text-[#191919]">Computer Science Degree</h4>
                                                <DateBadge>2016 — 2019</DateBadge>
                                            </div>
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">ISIG Kairouan</p>
                                        </div>
                                        ...
                                        <div className="border-l-3 border-[#191919]/20 pl-3 space-y-1">
                                            ...
                                            <p className="font-sans text-xs font-semibold text-[#191919]/70">Dar Lamen High School, Kairouan</p>
                                        </div>
                                    </div>
                                </section>
                            </div>
